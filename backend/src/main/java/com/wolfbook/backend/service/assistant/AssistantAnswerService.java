        ...
        if (!hits.isEmpty()) {
            ...
            if (hasWebAnswer(webSearchResult)) {
                ...
                streamedAnswer = emitStaticAnswer(
                        enrichAnswerWithEvidenceFreshness(appendSourceRatio(mergedAnswer, citations), citations),
                        emitter,
                        metrics
                );
            } else {
                ...
                streamedAnswer = emitStaticAnswer(
                        enrichAnswerWithEvidenceFreshness(appendSourceRatio(checkedAnswer, citations), citations),
                        emitter,
                        metrics
                );
            }
